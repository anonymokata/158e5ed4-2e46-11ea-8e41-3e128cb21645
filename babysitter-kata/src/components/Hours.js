        ...
        <div className='row m-3'>
            ...
            <form className='col-12 timeForm'>
                <div className="col-sm-12 col-md-6 form-group">
                    <label className='font-weight-bold mx-auto p-2 bg-white titles' htmlFor="formControlRange">Choose a start time</label>
                ...
                <div className="col-sm-12 col-md-6 form-group">
                    <label className='font-weight-bold mx-auto p-2 bg-white titles' htmlFor="formControlRange">Choose an end time</label>
